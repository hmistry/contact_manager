...
describe EmailAddressesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      let(:valid_session) { {address: 'asmith@mail.com', contact_id: alice.id, contact_type: "Person"} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:alice) { Person.create(first_name: 'Alice', last_name: 'Smith') }
      let(:valid_attributes) { { "address" => "MyString", contact_id: alice.id, contact_type: "Person" } }
      ...
      it "updates the requested email_address" do
        ...
        EmailAddress.any_instance.should_receive(:update).with({ "address" => "MyNewString" })
        put :update, {:id => email_address.to_param, :email_address => { "address" => "MyNewString" }}, valid_session
      end
